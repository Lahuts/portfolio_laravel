...
<body>
    ...
    <main>
        <section class="herobanner">
           <div class="pres">
            <h2>Full Stack <br> <span class="dev">Developer</span></h2>
            <p>Bonjour, je suis Alexis Huet dévéloppeur full stacks.Voici mon Portfolio sur l'année 2022 à 2023.</p>
            <p>Passionné d'informatique et développement plus généralement je suis la personne qu'il vous faut pour vous accompagner dans votre projet.</p>
            <a href="/about">EN SAVOIR PLUS</a>
           </div>
            <div class="last-project">
                <button class="btn-doc">Mes documents</button>
            </div>
        </section>
        <section class="projects">
            ...
            <a href="projets.html" class="decouvrir">EN SAVOIR PLUS</a>
        ...
        <section class="contact">
            <div>
                <h2>Vous voulez <br> plus d'informations ?</h2>
                <p>Une question ? n'hesitez pas envoyer un mail en cliquant <br> sur le bouton ,  je vous répondrez dans les meilleurs delais.</p>
